...
int main(int argc, const char** argv)
{
    ...
    auto window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, WINDOW_NAME, nullptr, nullptr); // 4(모니터 어떤?),5(다른 window랑 context share 할 것인지?)
    ...
    glfwMakeContextCurrent(window); // opengl context 생성
